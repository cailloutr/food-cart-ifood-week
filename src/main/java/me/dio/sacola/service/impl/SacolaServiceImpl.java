...
import me.dio.sacola.enumeretion.FormaPagamento;
import me.dio.sacola.model.Item;
import me.dio.sacola.model.Restaurante;
import me.dio.sacola.model.Sacola;
import me.dio.sacola.repository.ItemRepository;
import me.dio.sacola.repository.ProdutoRepository;
import me.dio.sacola.repository.SacolaReporitory;
...
public class SacolaServiceImpl implements SacolaService {
    private final SacolaReporitory sacolaRepository;
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        Item itemParaSerInserido = Item.builder()
                .quantitidade(itemDto.getQuantitidade())
                .sacola(sacola)
        ...
        List<Item> sacolaItems = sacola.getItems();
        if (sacolaItems.isEmpty()) {
            sacolaItems.add(itemParaSerInserido);
        } else {
            Restaurante restauranteAtual = sacolaItems.get(0).getProduto().getRestaurante();
        ...
        for (Item item : sacolaItems) {
            double valorTotalItem = item.getProduto().getValorUnitario() * item.getQuantitidade();
            valorDosItems.add(valorTotalItem);
        }

//        Double valorTotalSacola = 0.0;
//        for (Double valorItem : valorDosItems) {
